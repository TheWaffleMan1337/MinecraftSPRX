...
struct font_t { //font structure used for rendering text
...
class Timer { //game timer class, used for smelting and such?
public:

};

class LevelRenderer { //renders entities?
public:
...
public:
	...
	uint32_t fps; //could be fps or ping? but is always 120-140 and drops sometimes when you lag a bit
...
extern TheMinecraft * mc; //main minecraft class
extern ViewMatrix * viewMatrix; //for future use